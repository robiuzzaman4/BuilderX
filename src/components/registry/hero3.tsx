    ...
    <section className="py-12 bg-white border-b border-zinc-200">
      <div className="h-full w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-6 px-4">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-fuchsia-50 text-fuchsia-500 py-1 px-4 w-fit rounded-md text-sm font-medium">
            #1 Platform
          </div>
        ...
        {/* right section */}
        <div className="min-h-60 h-full w-full bg-fuchsia-50 border border-dashed border-fuchsia-500 rounded-md flex items-center justify-center font-mono">
          {JSON.stringify(
            {
              name: "Hero3",
            },
