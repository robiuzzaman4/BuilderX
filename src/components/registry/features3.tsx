        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {Array.from({ length: 2 }).map((_, index) => (
              ...
              >
                <div className="min-h-60 w-full md:w-60 bg-fuchsia-50 border border-dashed border-fuchsia-500 flex items-center justify-center font-mono text-sm rounded-md">
                  {`cirtificate`}
                </div>
