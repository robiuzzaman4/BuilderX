      ...
      <nav className="md:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-zinc-200">
        <div className="px-4 py-4 flex justify-between items-center">
          ...
          <button
            ...
            className="text-orange-600 hover:text-orange-700 transition hover:cursor-pointer bg-orange-50 p-2 rounded-md"
          >
        ...
        {isOpen && (
          <>
            ...
            <div className="absolute top-16 left-0 right-0 bg-white/98 backdrop-blur-md border-b border-orange-200 animate-in slide-in-from-top z-50">
